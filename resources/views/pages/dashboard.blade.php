                                ...
                                <div class="chat-wrap-list">
                                    <div class="clearfix">
                                        <div class="col-lg-custom-3"><img class="img-responsive img-circle"
                                                                          src="{{asset('public/copy_assets/')}}/img/blog-post-author.jpg"
                                                                          width="64" height="64"
                                                                          alt="User Image"></div>
                                    ...
                                    <div class="clearfix right-side">
                                        <div class="col-lg-custom-3"><img class="img-responsive img-circle"
                                                                          src="{{asset('public/copy_assets/')}}/img/register-user-3.jpg"
                                                                          width="64" height="64"
                                                                          alt="User Image"></div>
                                        <div class="col-lg-custom-9">
                                    ...
                                    <div class="clearfix right-side">
                                        <div class="col-lg-custom-3"><img class="img-responsive img-circle"
                                                                          src="{{asset('public/copy_assets/')}}/img/register-user-4.jpg"
                                                                          width="64" height="64"
                                                                          alt="User Image"></div>
                                        <div class="col-lg-custom-9">
                                    ...
                                    <div class="clearfix right-side">
                                        <div class="col-lg-custom-3"><img class="img-responsive img-circle"
                                                                          src="{{asset('public/copy_assets/')}}/img/histroy-user-2.png"
                                                                          width="64" height="64"
                                                                          alt="User Image"></div>
                                        <div class="col-lg-custom-9">
                    ...
                    <div class="prtm-block-content">
                        <div class="row prtm-new-user-list mrgn-b-md">
                            <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
                                <div class="feature-box-thumb"><img src="{{asset('public/copy_assets/')}}/img/register-user-1.jpg"
                                                                    alt="user's avtar"
                            ...
                            <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
                                <div class="feature-box-thumb"><img src="{{asset('public/copy_assets/')}}/img/register-user-2.jpg"
                                                                    alt="user's avtar"
                                                                    class="img-responsive width-full"
                                                                    width="100" height="100"/></div>
                            ...
                            <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
                                <div class="feature-box-thumb"><img src="{{asset('public/copy_assets/')}}/img/register-user-3.jpg"
                                                                    alt="user's avtar"
                                                                    class="img-responsive width-full"
                                                                    width="100" height="100"/></div>
                            ...
                            <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
                                <div class="feature-box-thumb"><img src="{{asset('public/copy_assets/')}}/img/register-user-4.jpg"
                                                                    alt="user's avtar"
                                                                    class="img-responsive width-full"
                                                                    width="100" height="100"/></div>
                            ...
                            <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
                                <div class="feature-box-thumb"><img src="{{asset('public/copy_assets/')}}/img/user-1.jpg"
                                                                    alt="user's avtar"
                                                                    class="img-responsive width-full"
                                                                    width="100" height="100"/></div>
                                <div class="feature-box-info"><span
                            ...
                            <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
                                <div class="feature-box-thumb"><img src="{{asset('public/copy_assets/')}}/img/user-2.jpg"
                                                                    alt="user's avtar"
                                                                    class="img-responsive width-full"
                                                                    width="100" height="100"/></div>
                                <div class="feature-box-info"><span
                            ...
                            <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
                                <div class="feature-box-thumb"><img src="{{asset('public/copy_assets/')}}/img/dami-user.png"
                                                                    alt="user's avtar"
                                                                    class="img-responsive width-full"
                                                                    width="100" height="100"/></div>
                                <div class="feature-box-info"><span
                            ...
                            <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
                                <div class="feature-box-thumb"><img src="{{asset('public/copy_assets/')}}/img/user-4.jpg"
                                                                    alt="user's avtar"
                                                                    class="img-responsive width-full"
                                                                    width="100" height="100"/></div>
                            ...
                            <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
                                <div class="feature-box-thumb"><img src="{{asset('public/copy_assets/')}}/img/user-5.jpg"
                                                                    alt="user's avtar"
                                                                    class="img-responsive width-full"
                                                                    width="100" height="100"/></div>
                                <div class="feature-box-info"><span
                            ...
                            <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
                                <div class="feature-box-thumb"><img src="{{asset('public/copy_assets/')}}/img/user-9.jpg"
                                                                    alt="user's avtar"
                                                                    class="img-responsive width-full"
                                                                    width="100" height="100"/></div>
                                <div class="feature-box-info"><span
                            ...
                            <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
                                <div class="feature-box-thumb"><img src="{{asset('public/copy_assets/')}}/img/user-7.jpg"
                                                                    alt="user's avtar"
                                                                    class="img-responsive width-full"
                                                                    width="100" height="100"/></div>
                                <div class="feature-box-info"><span
                        ...
                        <div class="prtm-wheather-widget text-center">
                            ...
                            <div class="clearfix mrgn-b-xs">
                                <div class="pull-left temp-status"><img class="img-responsive display-ib"
                                                                        src="{{asset('public/copy_assets/')}}/img/bottom-down.png"
                                ...
                                <div class="pull-right temp-status"><img class="img-responsive display-ib"
                                                                         src="{{asset('public/copy_assets/')}}/img/bottom-up.png"
                                                                         width="26" height="49"
                                    ...
                                    <div class="row mrgn-b-xs">
                                        <div class="col-xs-7 col-sm-3 col-md-6 col-lg-8">
                                            <div class="pull-left mrgn-r-sm"><img
                                                        ...
                                                        src="{{asset('public/copy_assets/')}}/img/register-user-1.jpg" width="64" height="64"
                                                        alt="User Photo"></div>
                                            <div class="pull-left">
                                ...
                                <div class="prtm-customer-list">
                                    <div class="row mrgn-b-xs">
                                        <div class="col-xs-7 col-sm-3 col-md-6 col-lg-8">
                                            <div class="pull-left mrgn-r-sm"><img
                                                        class="img-responsive display-ib img-circle"
                                                        src="{{asset('public/copy_assets/')}}/img/register-user-2.jpg" width="64" height="64"
                                                        alt="User Photo"></div>
                                            <div class="pull-left">
                                ...
                                <div class="prtm-customer-list">
                                    <div class="row mrgn-b-xs">
                                        <div class="col-xs-7 col-sm-3 col-md-6 col-lg-8">
                                            <div class="pull-left mrgn-r-sm"><img
                                                        class="img-responsive display-ib img-circle"
                                                        src="{{asset('public/copy_assets/')}}/img/blog-post-author.jpg" width="64" height="64"
                                                        alt="User Photo"></div>
                                            <div class="pull-left">
                                ...
                                <div class="prtm-customer-list">
                                    <div class="row mrgn-b-xs">
                                        <div class="col-xs-7 col-sm-3 col-md-6 col-lg-8">
                                            <div class="pull-left mrgn-r-sm"><img
                                                        class="img-responsive display-ib img-circle"
                                                        src="{{asset('public/copy_assets/')}}/img/user-10.jpg" width="64" height="64"
                                                        alt="User Photo"></div>
                                            <div class="pull-left">
